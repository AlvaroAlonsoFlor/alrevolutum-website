...
![The invocation description](./invocation-blinding-light-001.png)
...
> ![End of Session move](./stonetop-end-of-session-move.png)
> 
...
![Some of the markings from the tree](./forest-folk-glyph-maw-001.png)
_Wen's player came up with the glyphs, they are amazing!_

![Some interesting glyphs](./forest-folk-glyphs-001.png)
