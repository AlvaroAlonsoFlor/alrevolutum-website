...
![The Royal Edition](./uneasy-lies-the-head-materials.png)
...
![Poor Balder is plundered and then he gets the pirate names](./uneasy-lies-the-head-balder-assets-001.png)
...
![The General ended up with quite a few assets](./uneasy-lies-the-head-alasdair-assets-001.png)
...
![Storm Fort Recovered and Matilde on Ian's payroll](./uneasy-lies-the-head-ian-001.png)

## The public record (turns 1 to 5)

![Mandatory Gandalf GIF](./board-is-set.gif)

This is where the action happens. The board is set, the pieces are moving.

![The Public Record](./uneasy-lies-the-head-public-record-001.png)
